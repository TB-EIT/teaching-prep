...
| Done? | # | Assignment |
| --- | --- | --- |
| <input type="checkbox"> | 1 | Make a local git repository copy (clone) of an existing remote git repository (that you can push to). Save the screenshots. |
...
| <input type="checkbox"> | 8 | Restore file from being changed (before it was staged for commit). Unstage a file for commit. Reset a commit (soft and hard). Force-push commit reset. Revert a commit. Save the screenshots. |
