...
| 5 | Put an animal name into a variable (your choice how). Use switch/case/match constructs to output the sound that animal makes (handle an unexpected animal too). | <input type="checkbox"> | <input type="checkbox"> | <input type="checkbox"> |
