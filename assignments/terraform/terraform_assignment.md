...
| <input type="checkbox"> | 3 | What are the major difference between ARM and Terraform templates? |
...
| Done? | # | Assignment |
| --- | --- | --- |
| <input type="checkbox"> | 1 | Write a Terraform configuration file (template) for an App Service Deployment. Run terrform init, validate, plan, and apply commands to deploy the App Service (save the screenshots). |
...
| <input type="checkbox"> | 8 | Use count property to achieve conditional deployment in your in your configuration file. |
| <input type="checkbox"> | 9 | Use module in your configuration file. |
| <input type="checkbox"> | 10 | Configure the use of remote state file in your configuration file. |
